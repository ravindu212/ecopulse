...
export default function AssessmentPage() {
  ...
  async function submit() {
    if (!getAccessToken()) return setError("Please sign in first. EcoPulse stores the Phase 1 access token in sessionStorage.");
